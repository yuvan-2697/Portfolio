    ...
    <div className="relative min-h-screen bg-gradient-to-b from-[#D9D2C8] via-[#CFC8BE] to-[#BFB7AC] text-gray-900">
      ...
      <header className="fixed top-0 left-0 w-full z-20 px-6 py-6 flex justify-between items-center">
        ...
        <div className="relative">
          ...
          <div
            className={`absolute right-0 mt-3 w-48 bg-white rounded-xl shadow-lg flex flex-col py-2 z-30 transform transition-all duration-300 ease-in-out origin-top ${
              menuOpen
      ...
      <main className="relative z-10 pt-32 px-6 pb-16 max-w-6xl mx-auto flex flex-col md:flex-row items-start gap-12">
        ...
        <div className="flex-shrink-0 w-full md:w-1/3 relative overflow-hidden">
          ...
          <img
            src={portrait}
            alt="Ribhu Sarma"
            className="rounded-full shadow-xl w-80 h-80 object-cover mx-auto md:mx-0 transition-transform duration-500 hover:scale-105"
          />
          ...
          <div className="flex flex-col items-end gap-6">
            ...
            {contacts.map((contact, idx) => (
              <a
                ...
                target="_blank"
                rel="noreferrer"
                className="opacity-0 translate-x-10 flex items-center gap-4 text-right text-lg md:text-xl font-semibold transition-all duration-700 hover:text-black"
                style={{

// src/commercials/Dug.jsx
import React, { useState } from "react";
import { Link, useLocation } from "react-router-dom";
import { FiMenu, FiX } from "react-icons/fi";

export default function Dug() {
      ...
      <main className="relative z-10 pt-[120px] px-6 pb-16 max-w-5xl mx-auto flex flex-col items-center gap-12 text-center">
        ...
        <div className="w-full max-w-3xl aspect-video rounded-2xl overflow-hidden shadow-2xl">
          <iframe
            ...
            src="https://www.youtube.com/embed/l36QKGyqFwE"
            title="Dug Out"
            frameBorder="0"
        ...
        >
          A captivating commercial showcasing Dug Out Trampoline Park. Update description as needed.
        </p>
